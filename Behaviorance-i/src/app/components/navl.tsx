...
export default function Navl() {
  return (
    <div className="bg-gradient-to-r from-black to-blue-950 opacity-75 text-white pt-8">
      <div className="flex items-center justify-between px-5">
        ...
        <div className="mb-5 flex gap-x-20">
          <Link href="/">
            <h3 className="hover:bg-blue-800 font-bold px-3 rounded ring-2 ring-offset-2 ring-offset-blue-300 hover:ring-offset-blue-500">
              Home
            </h3>
          </Link>
          <Link href="/about">
