...
//       try {
//         const res = await fetch('/api/Template5/questions');
//         if (!res.ok) {
...
//   //   try {
//   //     const res = await fetch('/api/Template5/Submit', {
//   //       method: 'POST',
...
//   if (answers.length !== 10 || answers.includes("")) {
...
export default function TemplatePage() {
  ...
  const handleSubmit = async () => {
    const userId = Number(localStorage.getItem('userId'));
    const domainId = 5; // update dynamically if needed
