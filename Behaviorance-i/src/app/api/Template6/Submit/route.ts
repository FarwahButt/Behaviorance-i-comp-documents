// app/api/Template6/Submit/route.ts
...
export async function POST(req: NextRequest) {
  ...
  if (!userId || !Array.isArray(answers) || answers.length !== 11) {
  ...
  .input('Template_number', mssql.Int, 6) // ← replace with dynamic number
  .query(`
