...
//       try {
//         const res = await fetch('/api/Template2/questions');
//         if (!res.ok) {
...
//   //   try {
//   //     const res = await fetch('/api/Template2/Submit', {
//   //       method: 'POST',
...
//   const domainId = 2; // Template2 ka domain ID, agar dynamic chahiye to props se de sakte hain
...
//       return;
//     }
//     if (answers.length !== questions.length || answers.includes('')) {
//       alert('Please answer all questions.');
//       return;
//     }

//     try {
//       // Save answers to your backend API
//       const res = await fetch('/api/Template2/Submit', {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
//         body: JSON.stringify({ userId, answers }),
...
//       // Clear answers to reset selections
...
//   return (
//     <div className="max-w-4xl mx-auto px-4 py-8">
//       <h1 className="text-2xl font-bold mb-6 text-center">Device Security</h1>
...
//           style={{ background: 'linear-gradient(135deg, #1e3a8a, #000000)' }}
//         >
//           <h2 className="text-4xl font-serif font-semibold mb-6 text-center underline decoration-blue-400">
//             Your Suggestion
//           </h2>
//           <p className="text-lg leading-snug">{suggestion}</p>
//         </div>
//       )}
//     </div>
//   );
...
export default function TemplatePage() {
  ...
  const handleSubmit = async () => {
    const userId = Number(localStorage.getItem('userId'));
    const domainId = 2; // update dynamically if needed
